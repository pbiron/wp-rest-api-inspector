...
global $title;
$title = sprintf(
	__(	'REST API Schema Properties for route &#8220;%s&#8221', 'shc-rest-api-inspector' ),
...
get_current_screen()->add_help_tab(
	array(
		...
		'title'   => __( 'Overview' ),
		'content' =>
			'<p>' . __( 'This screen provides access to all the properties in the schema for a given route. You can customize the display of this screen to suit your workflow.', 'shc-rest-api-inspector' ) . '</p>'
	)
);
...
add_screen_option(
	...
	array(
		'default' => 20,
		'option'  => 'schema_property_per_page',
	)
);
...
<div class="wrap">
	...
	<?php
	echo esc_html( __( 'Schema Properties', 'shc-rest-api-inspector' ) );
	 ?>
	</h1>
<?php
...
?>
	...
	<?php
		printf(
			__(	'Route: &#8220;%s&#8221', 'shc-rest-api-inspector' ),
			esc_html( wp_unslash( $_GET['schema-properties'] ) )
		);
	?>
	</h2>
...
<form id="rest-api-schema-properties-filter" method="get">
<?php $wp_list_table->search_box( $item_type_object->labels->search_items, 'rest_api_schema_property' ); ?>
...
<input type="hidden" name="schema-properties" class="schema-properties" value="<?php echo esc_attr( wp_unslash( $_REQUEST['schema-properties'] ) ) ?>" />
