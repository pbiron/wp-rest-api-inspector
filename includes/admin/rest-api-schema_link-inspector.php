...
global $title;
$title = sprintf(
	__(	'REST API Schema Links for route &#8220;%s&#8221', 'shc-rest-api-inspector' ),
...
get_current_screen()->add_help_tab(
	array(
		...
		'title'   => __( 'Overview' ),
		'content' =>
			'<p>' . __( 'This screen provides access to all the links in the schema for a given route. You can customize the display of this screen to suit your workflow.', 'shc-rest-api-inspector' ) . '</p>'
	)
);
...
<div class="wrap">
	...
	<?php
	echo esc_html( __( 'Schema Links', 'shc-rest-api-inspector' ) );
	 ?>
	</h1>
<?php
...
<form id="rest-api-schema-links-filter" method="get">
<?php $wp_list_table->search_box( $item_type_object->labels->search_items, 'rest_api_schema_link' ); ?>
...
<input type="hidden" name="schema-links" class="schema-links" value="<?php echo esc_attr( wp_unslash( $_REQUEST['schema-links'] ) ) ?>" />
